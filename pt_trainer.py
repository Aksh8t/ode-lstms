...
def main():
    ...
    def load_dataset():
        ...
        trainloader = DataLoader(TensorDataset(train_x, train_t, train_y), batch_size=args.batch_size, shuffle=True)
        testloader = DataLoader(TensorDataset(test_x, test_t, test_y), batch_size=args.batch_size, shuffle=False)
